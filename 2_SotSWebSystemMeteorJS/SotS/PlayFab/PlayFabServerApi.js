...
if(!PlayFab.settings) {
    PlayFab.settings = {
        titleId: "336E0", // You must set this value for PlayFabSdk to work properly (Found in the Game Manager for your title, at the PlayFab Website)
        developerSecretKey: "AQRNQM7A4KB6SHPN9GQIQ3ASX9MU7A7SWTD6E13OCDXBG6HOU3", // For security reasons you must never expose this value to the client or players - You must set this value for Server-APIs to work properly (Found in the Game Manager for your title, at the PlayFab Website)
...
export var PlayFabServerSDK = PlayFab.ServerApi;
