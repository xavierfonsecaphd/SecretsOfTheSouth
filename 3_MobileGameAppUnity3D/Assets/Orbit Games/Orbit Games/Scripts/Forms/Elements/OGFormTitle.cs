...
public class OGFormTitle : OGFormBaseElementGeneric<OGForm.TitleElement>
{
    [Header("References")]
    public LocalizedTextBehaviour titleField;
    ...
    {
        titleField.FormattedAsset = elementSetup.labelText;
    }
